...
class VersionPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/rest/version', $namespaces, $module_handler, 'Drupal\rest_version\Plugin\rest\version\VersionInterface', 'Drupal\rest_version\Annotation\RestVersion');
